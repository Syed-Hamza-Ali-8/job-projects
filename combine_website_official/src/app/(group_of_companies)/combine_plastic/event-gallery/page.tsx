...
const page = () => {
  ...
  const galleryImages = [
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-1.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-2.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-3.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-4.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-5.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-6.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-7.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-8.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-9.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-10.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-11.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-12.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-13.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-14.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-15.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-16.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-17.jpg",
    "/Group-of-Companies/combine-plastic/event-gallery/combine-plastic-event-images-18.jpg",
  ];
  ...
  return (
    <>
      ...
      <section className="py-16 px-4 sm:px-8 md:px-16 lg:px-24 bg-white">
        <h2 className="text-center text-2xl sm:text-3xl md:text-4xl font-bold font-montserrat text-green-600 mb-10 tracking-wide">
          Event Gallery
        </h2>
      ...
      <section className="relative bg-[#b8afa9] text-white py-16 px-4 sm:px-8 md:px-16 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          ...
          <a
            href="/Contact"
            className="bg-[#03820a] hover:bg-[#19be21] transition text-white font-semibold py-3 px-6 rounded-md shadow-lg font-montserrat"
          >
            CONTACT US
          </a>
        </div>
