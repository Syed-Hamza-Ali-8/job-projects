...
const OurTeamPage = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      name: "Abdul Kareem",
      designation: "Finance",
      image: "/Group-of-Companies/combine-plastic/our-team/dummy-profile.jpg",
      facebook: "https://facebook.com/amin",
      twitter: "https://x.com/amin",
      linkedin: "https://linkedin.com/in/amin",
      instagram: "https://instagram.com/amin",
    ...
    <>
      ...
      <section className="bg-white py-14 px-4 sm:px-10 md:px-20 lg:px-28 text-center space-y-6">
        <h2 className="text-2xl sm:text-3xl font-semibold tracking-wide">
          <span className="text-green-500">Combine Plastic</span>
        </h2>
        ...
        <div className="relative h-12 sm:h-14 md:h-16">
          <p
            className={`absolute inset-0 text-2xl sm:text-3xl md:text-4xl font-semibold tracking-wide text-green-500 transition-opacity duration-700 ${
