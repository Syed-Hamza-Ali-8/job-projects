  ...
  return (
    <nav className="relative w-full bg-[#f0f3ff] py-4 px-4 md:px-8 lg:px-16 shadow-sm font-montserrat flex items-center justify-between">
      ...
      <div className="flex items-center z-20">
        <Image
          src="/Group-of-Companies/pakistan-supply-chain/combine-supplychain-logo.png"
          alt="Combine Logo"
          width={200}
          height={200}
      ...
      <ul className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 gap-4 lg:gap-8 text-[13px] sm:text-[14px] md:text-[15px] font-semibold items-center justify-center text-center">
        ...
        <li>
          <Link
            href="/pakistan_supply_chain/our-purpose"
        ...
        <li>
          <Link
            href="/pakistan_supply_chain/pavilion-members"
            className="hover:text-[#003a7b] transition"
          >
            Pavilion Members
          </Link>
        ...
        <li>
          <Link
            href="/pakistan_supply_chain/showcase-partners"
        ...
        <li>
          <Link
            href="/pakistan_supply_chain/become-a-member"
            className="hover:text-[#003a7b] transition"
          >
            Become a Member
          </Link>
...
export default PakistanSupplyChain;
